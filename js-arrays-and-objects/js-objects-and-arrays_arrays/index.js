...
const exampleArray = [true, 7, "string"];
console.log("modified", exampleArray);

// EXERCISE 2
// Nest an array inside array nestedArray. After that nestedArray should contain an array as an element.

const nestedArray = ["example", 10, [4, false, "second array"], true];
...
console.log("firstnumber should be:", firstNumber);
...
const newAnimal = petsWithPush.push("rat");
...
fruitsWithPop.pop();
console.log("fruits with pop:", fruitsWithPop);
